...
<html lang="en"> 
  <head> 
    ...
    <title>My Portofolio | Anka Riana</title> 
  ...
  <body id="home"> 
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm fixed-top"> 
      ...
      <section class="jumbotron text-center"> 
        <img src="img/foto.jpeg" alt="Anka Riana " width="200"class="rounded-circle img-thumbnail"> 
        <h1 class="display-4">Anka Riana</h1> 
        ...
        <section id="projects"> 
          <div class="container"> 
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card" >
                        <img src="img/project/php.png" class="card-img-top" alt="project 1">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" >
                        <img src="img/project/html.png" class="card-img-top" alt="project 2">
                        <div class="card-body">
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                      </div>
                ...
                <div class="col-md-4">
                    <div class="card" >
                        <img src="img/project/css.jpg" class="card-img-top" alt="project 3">
                        <div class="card-body">
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                      </div>
    ...
    <footer class="bg-primary text-white text-center pb-5">
        <p>Created with <i class="bi bi-heart-fill text-danger"></i> by <a href="https://www.instagram.com/ankariana_/" class="text-white fw-bold">anka riana</a></p>
    </footer>
    <!-- Akhir Footer -->
